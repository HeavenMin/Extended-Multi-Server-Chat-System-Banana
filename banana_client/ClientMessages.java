...
public class ClientMessages {
	...
	@SuppressWarnings("unchecked")
	public static JSONObject sendUsernameAndPassword(String userName, String passWord) {
		JSONObject sendAuthen = new JSONObject();
		sendAuthen.put("type", "clientAuthen");
		sendAuthen.put("username", userName);
		sendAuthen.put("password", passWord);
		return sendAuthen;
	}
