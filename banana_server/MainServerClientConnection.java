...
public class MainServerClientConnection extends Thread{
	...
	public void run(){
		...
		try{
			//å¼€å�¯æŽ¥æ”¶clientçš„sslserversocket
			...
			//æŠŠå·²ç»�å®šåž‹å¥½çš„usernameå’Œpasswordå¼„åˆ°è¿™ä¸ªç¨‹åº�é‡Œ
			...
			while(true){
				...
				boolean exist = false;
				//å¦‚æžœç”¨æˆ·å­˜åœ¨ï¼Œç”¨æˆ·å��å¯†ç �å¯¹åº”æ­£ç¡®ï¼Œç”¨æˆ·å��å¹¶æ²¡æœ‰è¢«é”�ä½�é‚£ä¹ˆè¿”å›žtrueè®©ç”¨æˆ·é¡ºåˆ©ç™»é™†
